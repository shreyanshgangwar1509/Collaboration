  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 animate-gradient text-white">
      ...
      <div className="text-center mb-10">
        ...
        <button 
          className="mt-4 px-6 py-3 bg-pink-600 text-white rounded-lg text-lg font-semibold transition transform hover:scale-105 hover:bg-pink-500"
      ...
      <div className="flex flex-wrap justify-center gap-6 max-w-4xl">
        {features.map((feature, index) => (
          <div
            ...
            className="bg-white/10 backdrop-blur-md p-6 rounded-lg w-40 md:w-48 text-center transition transform hover:-translate-y-2 hover:shadow-lg hover:bg-white/20 cursor-pointer"
          >
            <div className="text-4xl">{feature.icon}</div>
            <h3 className="text-lg font-semibold mt-2">{feature.title}</h3>
            <p className="text-sm text-gray-300">{feature.description}</p>
...
const features = [
  ...
  { title: "Docs", description: "Collaborate on documents", icon: "📄", path: "/docs" },
  { title: "PPT", description: "Work on presentations", icon: "📊", path: "/ppt" },
  { title: "Code Editor", description: "Write & share code", icon: "💻", path: "/home/editor" },
  { title: "More Tools", description: "Enhance your workflow", icon: "🚀", path: "/more" },
];
